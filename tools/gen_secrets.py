...
REQUIRED_KEYS = ("BOT_TOKEN", "WIFI_SSID", "WIFI_PASSWORD")
...
def main():
    ...
    lines = [
        ...
        "",
        # The token is the only thing that identifies the pager to Telegram.
        # There is no chat id: every chat that writes to the bot is paged, and
        # each receipt goes back to the chat its message came from.
